...
class Employee:
    fname = String("_fname", min_len=4, max_len=8)
    lname = String("_lname", min_len=5, max_len=12)
    pay = Number("_pay", min_value=1000, max_value=90000)
...
e = Employee("steve","jobsss",1000,25)
...
e1 = Employee("steve","jobs",1000,23)
#e2 = Employee("Elon","musk",2000,25)
